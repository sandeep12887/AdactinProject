	...
	public PropertyReader() throws Throwable {
		try {
			...
			File propFILE = new File(
					System.getProperty("user.dir") + "\\src\\test\\resource\\com\\configuration\\config.properties");
					//System.getProperty("C:\\Users\\admin\\eclipse-workspace\\AdactinHotelReservation\\Resource\\config.properties"));
