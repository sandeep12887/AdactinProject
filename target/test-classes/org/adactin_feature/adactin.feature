...
And      User should enter valid username  "<username>" 
...
Scenario Outline: TC-2.To verify whether the check-out date field accepts a 
 ...
 |Sydney|Hotel Sunshine|Double|3|25/05/2019|27/05/2019|2|3|
  ...
  Scenario Outline:TC-4. To verify whether the total price (excl.GST) is calculated as “price per night * no. of nights*
                     no of rooms
